...
5. start a new terminal and run ./enter_sglang_uv_and_clone_eval.sh to enter the virtual environment
6. cd /sgl-workspace/multi-model-process-eval/scripts/embedding/sglang
7. SYNTHETIC_TOKEN_LEN=20 BACKEND=sglang ./run_fix_token_len.sh
